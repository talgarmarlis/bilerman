...
(
    ...
    CONSTRAINT question_question_id_pk
    PRIMARY KEY,
    title VARCHAR(500) NOT NULL,
    description TEXT,
    selected_response_id INTEGER REFERENCES bilerman.response(response_id),
...
CREATE TABLE bilerman.question_tag
(
...
(
    ...
    CONSTRAINT response_response_id_pk
    PRIMARY KEY,
...
(
    response_reply_id SERIAL NOT NULL
    CONSTRAINT response_reply_response_reply_id_pk
    PRIMARY KEY,
    response_id INTEGER NOT NULL REFERENCES bilerman.answer(answer_id) ON DELETE CASCADE,
